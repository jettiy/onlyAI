...
export const cloudProviders: CloudProvider[] = [
  {
    ...
    freetier: '30개 이상 무료 모델 (Llama 4, GLM-4.7 Flash 등 포함), 유료는 종량제',
  ...
  },
  {
    ...
    name: 'Groq',
    url: 'https://groq.com',
    description: '전용 LPU(언어처리장치) 칩으로 업계 최고 추론 속도. Llama 4·Gemma 4·Mixtral을 초고속으로 처리.',
  ...
  },
  {
    ...
    description: 'Google 공식 Gemini API. Gemini 3.1 Pro·3.5 Flash·Gemma 모두 지원. 1M 컨텍스트 윈도우 독보적.',
    freetier: 'Gemini 3.5 Flash 무료 (분당 15회), AI Studio 개인 사용 무료',
  ...
  },
  {
    ...
    description: 'MiniMax 공식 API. Hailuo 2.3 비디오·음성·텍스트 멀티모달. 비용 효율 뛰어남.',
