...
const FALLBACK_PRICES: PriceRow[] = [
  // ── OpenAI ──
  { model: 'GPT-5.5', provider: 'OpenAI', input: 5.00, output: 30.0, cacheRead: 0.50, cacheWrite: 5.00, context: '256K', note: 'Intelligence #2', isNew: true, koreanBilling: true,
  },
  ...
  // ── Anthropic ──
  { model: 'Claude Opus 4.8', provider: 'Anthropic', input: 7.50, output: 37.5, cacheRead: 0.75, cacheWrite: 9.375, context: '1M', note: 'Intelligence #1', isNew: true, koreanBilling: true,
  },
  { model: 'Claude Opus 4.7', provider: 'Anthropic', input: 5.0, output: 25.0, cacheRead: 0.50, cacheWrite: 6.25, context: '1M', note: '시각 분석', isNew: true, koreanBilling: true,
  },
  ...
  // ── Google ──
  { model: 'Gemini 3.5 Flash', provider: 'Google', input: 1.25, output: 5.0, cacheRead: 0.3125, cacheWrite: 1.25, context: '1M', note: '속도 리더', isNew: true, koreanBilling: true,
  },
  ...
  { model: 'Kimi K2.6', provider: 'Moonshot', input: 0.80, output: 3.0, cacheRead: 0.08, cacheWrite: 0.80, context: '128K', note: '오픈웨이트#1', isNew: true, koreanBilling: true,
  },
  { model: 'DeepSeek V4 Pro', provider: 'DeepSeek', input: 0.50, output: 1.5, cacheRead: 0.05, context: '1M', note: '오픈웨이트', isNew: true, koreanBilling: true,
  },
