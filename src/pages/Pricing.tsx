...
const FALLBACK_PRICES: PriceRow[] = [
  // ── OpenAI ──
  { model: 'GPT-5.5 Pro', provider: 'OpenAI', input: 5.00, output: 30.0, cacheRead: 0.50, cacheWrite: 5.00, context: '1M', note: 'Intelligence #2', isNew: true, koreanBilling: true,
  },
  { model: 'GPT-5.4', provider: 'OpenAI', input: 2.50, output: 15.0, cacheRead: 0.25, cacheWrite: 2.50, context: '270K', note: '최고 성능', isNew: false, koreanBilling: true,
  },
  ...
  // ── Anthropic ──
  { model: 'Claude Opus 4.8', provider: 'Anthropic', input: 5.00, output: 25.0, cacheRead: 0.50, cacheWrite: 6.25, context: '1M', note: 'Intelligence #1', isNew: true, koreanBilling: true,
  },
  { model: 'Claude Opus 4.7', provider: 'Anthropic', input: 5.0, output: 25.0, cacheRead: 0.50, cacheWrite: 6.25, context: '1M', note: '검증됨', isNew: false, koreanBilling: true,
  },
  { model: 'Claude Opus 4.6', provider: 'Anthropic', input: 5.0, output: 25.0, cacheRead: 0.50, cacheWrite: 6.25, context: '1M', note: '검증됨', koreanBilling: true,
  },
  ...
  { model: 'Claude Sonnet 4.6', provider: 'Anthropic', input: 3.0, output: 15.0, cacheRead: 0.30, cacheWrite: 3.75, context: '200K', note: '균형', isNew: false, koreanBilling: true,
  },
  ...
  { model: 'Claude Fable 5', provider: 'Anthropic', input: 10.00, output: 50.0, cacheRead: 0.10, context: '1M', note: '최고 성능', isNew: true, koreanBilling: true,
  },
  { model: 'Claude Mythos 5', provider: 'Anthropic', input: 0, output: 0, context: '—', note: '초청전용', isNew: true, koreanBilling: true,
  },
  // ── Google ──
  { model: 'Gemini 3.5 Pro', provider: 'Google', input: 0, output: 0, context: '—', note: '6월 GA 예정', isNew: true, koreanBilling: true,
  },
  { model: 'Gemini 3.5 Flash', provider: 'Google', input: 1.25, output: 5.0, cacheRead: 0.3125, cacheWrite: 1.25, context: '1M', note: '속도 리더', isNew: false, koreanBilling: true,
  },
  { model: 'Gemini 3.1 Pro', provider: 'Google', input: 2.0, output: 12.0, cacheRead: 0.625, cacheWrite: 2.50, context: '1M', note: '멀티모달', isNew: false, koreanBilling: true,
  },
  ...
  // ── xAI ──
  { model: 'Grok 4.3', provider: 'xAI', input: 1.50, output: 5.0, cacheRead: 0.15, cacheWrite: 1.50, context: '256K', note: '가성비', isNew: true, koreanBilling: null,
  },
  { model: 'Grok 4.20', provider: 'xAI', input: 2.0, output: 6.0, cacheRead: 0.20, cacheWrite: 2.00, context: '2M', note: '실시간', isNew: false, koreanBilling: null,
  },
  ...
  // ── 중국 ──
  { model: 'Qwen 3.7 Max', provider: 'Alibaba', input: 1.50, output: 6.0, cacheRead: 0.15, cacheWrite: 1.50, context: '1M', note: '속도 최강', isNew: true, koreanBilling: true,
  },
  { model: 'GLM-5.1', provider: 'Zhipu AI', input: 1.50, output: 5.0, cacheRead: 0.15, cacheWrite: 1.50, context: '128K', note: '에이전트', isNew: true, koreanBilling: true,
  },
  { model: 'Kimi K2.7 Code', provider: 'Moonshot', input: 0.95, output: 4.00, cacheRead: 0.095, cacheWrite: 0.95, context: '256K', note: '코딩 특화', isNew: true, koreanBilling: true,
  },
  { model: 'Kimi K2.6', provider: 'Moonshot', input: 0.80, output: 3.0, cacheRead: 0.08, cacheWrite: 0.80, context: '128K', note: '오픈웨이트#1', isNew: false, koreanBilling: true,
  },
  { model: 'DeepSeek V4 Pro', provider: 'DeepSeek', input: 0.435, output: 0.87, cacheRead: 0.05, context: '1M', note: '오픈웨이트', isNew: true, koreanBilling: true,
  },
  { model: 'MiMo V2.5 Pro', provider: 'Xiaomi', input: 0.80, output: 2.4, cacheRead: 0.08, cacheWrite: 0.80, context: '1M', note: 'MIT 라이선스', isNew: true, koreanBilling: true,
  },
  { model: 'MiniMax M2.7', provider: 'MiniMax', input: 0.30, output: 1.20, cacheRead: 0.03, cacheWrite: 0.30, context: '204K', note: '에이전트', isNew: false, koreanBilling: true,
  },
  { model: 'MiniMax M3', provider: 'MiniMax', input: 0.30, output: 1.20, cacheRead: 0.03, cacheWrite: 0.30, context: '1M', note: '오픈웨이트', isNew: true, koreanBilling: true,
  },
  ...
  // ── Microsoft ──
  { model: 'MAI-Code-1-Flash', provider: 'Microsoft', input: 0.75, output: 4.50, cacheRead: 0.075, cacheWrite: 0.75, context: '270K', note: '코딩 특화', isNew: true, koreanBilling: null,
  },
  { model: 'MAI-Thinking-1', provider: 'Microsoft', input: 0, output: 0, context: '—', note: '프라이빗 프리뷰', isNew: true, koreanBilling: null,
  },
  // ── NVIDIA ──
  { model: 'NVIDIA Nemotron 3 Ultra', provider: 'NVIDIA', input: 2.50, output: 7.50, cacheRead: 0.25, cacheWrite: 2.50, context: '128K', note: '코딩·수학', isNew: true, koreanBilling: null,
  },
];
