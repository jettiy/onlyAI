...
const FALLBACK_PRICES: PriceRow[] = [
  { model: 'GPT-5', provider: 'OpenAI', input: 1.25, output: 10.0, cacheRead: 0.125, cacheWrite: 1.25, context: '128K', note: '최고 성능', isNew: true },
  { model: 'GPT-5 Mini', provider: 'OpenAI', input: 0.25, output: 2.0, cacheRead: 0.025, cacheWrite: 0.25, context: '128K', note: '가성비' },
  { model: 'GPT-5 Nano', provider: 'OpenAI', input: 0.05, output: 0.20, cacheRead: 0.005, cacheWrite: 0.05, context: '128K', note: '최저가' },
  { model: 'Claude Opus 4.6', provider: 'Anthropic', input: 5.0, output: 25.0, cacheRead: 0.50, cacheWrite: 6.25, context: '200K', note: '긴 문맥' },
  { model: 'Claude Sonnet 4.6', provider: 'Anthropic', input: 3.0, output: 15.0, cacheRead: 0.30, cacheWrite: 3.75, context: '200K', note: '균형' },
  ...
  { model: 'MiniMax M2.7', provider: 'MiniMax', input: 0.8, output: 2.4, context: '128K', note: 'NEW', isNew: true },
  { model: 'DeepSeek V3.2', provider: 'DeepSeek', input: 0.27, output: 1.10, cacheRead: 0.027, context: '128K', note: '가성비' },
