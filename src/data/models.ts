...
export const models: AIModel[] = [
  ...
  // OpenAI ─────────────────────
  {
    ...
    description: '2026년 3월 OpenAI 최신 플래그십. 네이티브 컴퓨터 사용 기능 탑재. 1M 컨텍스트. 전문가용 업무 최강.',
  ...
  // Anthropic ─────────────────────
  {
    ...
    tier: 'flagship', isFeatured: true,
    description: '2026년 2월 Anthropic 최신 플래그십. 코딩·에이전트 작업 대폭 강화. 1M 컨텍스트 지원(베타). Terminal-Bench 2.0 최고점.',
  ...
  },
  {
    ...
    company: 'Anthropic', companyId: 'anthropic', region: 'us',
    tier: 'strong', isFeatured: true,
    description: '2026년 기본 모델로 채택. Opus급 코딩 성능을 절반 가격에. 오피스 작업은 Opus 4.6 능가. 1M 컨텍스트.',
