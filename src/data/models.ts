...
export const models: AIModel[] = [
  ...
  // OpenAI ─────────────────────
  {
    ...
    description: '2026년 3월 OpenAI 최신 플래그십. 네이티브 컴퓨터 사용 기능 탑재. 270K 컨텍스트. 전문가용 업무 최강.',
    strengths: ['최신 플래그십', '컴퓨터 사용', '270K 컨텍스트', '에이전트'],
    inputPrice: 2.50, outputPrice: 15.0, contextWindow: '270K',
  ...
  },
  {
    ...
    inputPrice: 0.20, outputPrice: 1.25, contextWindow: '270K',
    isLocal: false, isNew: true, releaseDate: '2026-03',
    koreanSupport: 'B',
