...
export const models: AIModel[] = [
  ...
  // OpenAI ─────────────────────
  {
    ...
    description: '2026년 3월 OpenAI 최신 플래그십. 네이티브 컴퓨터 사용 기능 탑재. 1.1M 컨텍스트. 전문가용 업무 최강.',
    strengths: ['최신 플래그십', '컴퓨터 사용', '1.1M 컨텍스트', '에이전트'],
    inputPrice: 2.50, outputPrice: 15.0, contextWindow: '1.1M',
  ...
  },
  {
    ...
    description: 'GPT-5.4 아키텍처 경량 버전. 2026년 3월 출시. 빠르고 저렴하면서 높은 품질.',
    strengths: ['최신 경량', '빠름', '저가', '에이전트'],
    inputPrice: 0.40, outputPrice: 1.60, contextWindow: '128K',
    isLocal: false, isNew: true, releaseDate: '2026-03',
    koreanSupport: 'A',
    useCases: ['챗봇', '요약', '분류', '대량 API'],
    sourceUrl: 'https://openai.com/api/pricing/',
    updatedAt: '2026-03-20',
  },
  {
    ...
    inputPrice: 1.25, outputPrice: 5.0, contextWindow: '200K',
  ...
  },
  {
    ...
    inputPrice: 1.75, outputPrice: 14.0, contextWindow: '200K',
  ...
  },
  {
    ...
    inputPrice: 3.0, outputPrice: 12.0, contextWindow: '1M',
  ...
  },
  {
    ...
    inputPrice: 0.8, outputPrice: 3.2, contextWindow: '1M',
    isLocal: false, isNew: false, releaseDate: '2025-04',
    koreanSupport: 'B',
  ...
  // Anthropic ─────────────────────
  {
    ...
    tier: 'flagship', isFeatured: true,
    description: '2026년 2월 Anthropic 최신 플래그십. 코딩·에이전트 작업 대폭 강화. 500개 이상 오픈소스 보안취약점 발견.',
    strengths: ['최강 추론', '코딩', '에이전트', '200K 컨텍스트'],
  ...
  },
  {
    ...
    company: 'Anthropic', companyId: 'anthropic', region: 'us',
    tier: 'strong', isFeatured: true,
    description: '2026년 기본 모델로 채택. Opus급 코딩 성능을 절반 가격에. 오피스 작업은 Opus 4.6 능가.',
  ...
  // xAI ─────────────────────
  {
    ...
    inputPrice: 3.0, outputPrice: 15.0, contextWindow: '2M',
    isLocal: false, isNew: true, releaseDate: '2026-03',
    koreanSupport: 'B',
  ...
  // DeepSeek ─────────────────────
  {
    ...
    tier: 'strong', isFeatured: true,
    description: '최신 DeepSeek 주력 모델(deepseek-chat). 캐시 미스 $0.28/캐시 히트 $0.028. 추론 모드도 지원.',
    strengths: ['최강 가성비', '코딩', '추론 모드', '캐시 할인'],
    inputPrice: 0.28, outputPrice: 0.42, contextWindow: '128K',
  ...
  },
  {
    ...
    inputPrice: 0.55, outputPrice: 2.19, contextWindow: '64K',
    params: '671B MoE',
    isLocal: false, isNew: false, releaseDate: '2025-01',
    koreanSupport: 'B',
    useCases: ['수학 문제', '논리 추론', '코딩 챌린지'],
  ...
  // Zhipu AI ─────────────────────
  {
    ...
    tier: 'flagship', isFeatured: true,
    description: '즈푸AI 최신 플래그십. 128K 컨텍스트. 추론·코딩·에이전트 강화. 입력 $1.0/출력 $3.2.',
    strengths: ['플래그십', '추론', '코딩', '에이전트'],
    inputPrice: 1.0, outputPrice: 3.2, contextWindow: '128K',
    isLocal: false, isNew: true, releaseDate: '2026-01',
    koreanSupport: 'B',
  ...
  },
  {
    ...
    company: 'Zhipu AI', companyId: 'zhipu', region: 'china',
    tier: 'flagship', isFeatured: false,
    description: '즈푸AI 플래그십 Turbo 버전. 빠른 응답 속도. 입력 $1.2/출력 $4.0. 128K 컨텍스트.',
    strengths: ['빠른 플래그십', '응답 속도', '중국어', '128K'],
    inputPrice: 1.2, outputPrice: 4.0, contextWindow: '128K',
    isLocal: false, isNew: true, releaseDate: '2026-01',
    koreanSupport: 'B',
  ...
  },
  {
    ...
    company: 'Zhipu AI', companyId: 'zhipu', region: 'china',
    tier: 'strong', isFeatured: false,
    description: '즈푸AI 고성능 모델. 128K 컨텍스트. 입력 $0.60/출력 $2.2. 중국어 특화.',
    strengths: ['고성능', '중국어', '코딩', '128K 컨텍스트'],
    inputPrice: 0.60, outputPrice: 2.2, contextWindow: '128K',
    isLocal: false, isNew: false, releaseDate: '2025-10',
    koreanSupport: 'B',
